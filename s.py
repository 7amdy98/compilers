...
rules = ["stmt-seq -> statement stmt-seq'",
         "stmt-seq' -> stmt-seq | epsilon",
         "statement -> repeat-stmt | assign-stmt",
         "repeat-stmt -> repeat stmt-seq until Identifier",
         "assign-stmt -> Identifier := factor ;",
         "factor -> Identifier | Number"
         ]
nonterm_userdef = ["stmt-seq", "statement", "repeat-stmt", "assign-stmt", "factor", "stmt-seq'"]
term_userdef = ['Identifier', ':=', 'Number', ';', 'until', 'repeat', 'epsilon']
